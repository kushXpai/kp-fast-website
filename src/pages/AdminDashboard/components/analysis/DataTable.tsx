...
const DataTable: React.FC<DataTableProps> = ({
    ...
    const renderMonitoringRow = (entry: FormEntry) => (
        <tr key={entry.id} className="border-b border-gray-200 hover:bg-gray-50">
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${entry.session_type === 'Match' ? 'bg-red-100 text-red-800' :
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${parseInt(entry.session_intensity || '0') >= 8 ? 'bg-red-100 text-red-800' :
    ...
    const renderWellnessRow = (entry: FormEntry) => (
        <tr key={entry.id} className="border-b border-gray-200 hover:bg-gray-50">
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${parseInt(entry.sleep_quality || '3') >= 4 ? 'bg-green-100 text-green-800' :
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${parseInt(entry.physical_readiness || '3') >= 4 ? 'bg-green-100 text-green-800' :
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${parseInt(entry.mood || '3') >= 4 ? 'bg-green-100 text-green-800' :
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${parseInt(entry.mental_alertness || '3') >= 4 ? 'bg-green-100 text-green-800' :
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${parseInt(entry.muscle_soreness || '3') <= 2 ? 'bg-green-100 text-green-800' :
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${entry.menstrual_cycle === 'Yes' ? 'bg-pink-100 text-pink-800' : 'bg-gray-100 text-gray-800'
                    }`}>
    ...
    const renderRecoveryRow = (entry: FormEntry) => (
        <tr key={entry.id} className="border-b border-gray-200 hover:bg-gray-50">
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${(entry.injury_present === 'Yes' || entry.injury_status === 'Yes') ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                    }`}>
