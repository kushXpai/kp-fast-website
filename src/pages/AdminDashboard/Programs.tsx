// src/pages/AdminDashboard/Programs.tsx
...
const Programs: React.FC = () => {
    ...
    const handleSubmit = async () => {
        // Validate form
        if (!formData.title || !formData.category || !formData.batch || !formData.description) {
        ...
        try {
            ...
            const programData = {
                ...
                batch: formData.batch as BatchEnum,
    ...
    const filteredPrograms = programs.filter(program => {
        ...
        const matchesTeam = selectedTeam === 'All Teams' || program.batch === selectedTeam;
    ...
    const teamsStats = programs.reduce((acc, program) => {
        acc[program.batch] = (acc[program.batch] || 0) + 1;
        return acc;
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Create and manage fitness programs for teams</p>
                    </div>
                    <button
                            ...
                            <div className="p-6 border-b border-gray-200">
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Create a fitness program and assign it to a team</p>
                                    </div>
                                    <button
                                        onClick={closeModal}
