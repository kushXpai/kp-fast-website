...
export default function PendingApprovals({ player, onNavigate }: PendingApprovalsProps) {
    ...
    const handleReviewPlayer = (playerId: string) => {
        // Navigate to player details page or open modal
        console.log('Review player:', playerId);
        // You can implement navigation here or open a modal
    };
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {/* <button
                                            ...
                                            className="flex items-center gap-1 px-4 py-2 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition-colors disabled:opacity-50 border border-gray-300"
                                        >
