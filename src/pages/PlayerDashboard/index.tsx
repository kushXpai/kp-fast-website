// src/pages/PlayerDashboard/index.tsx
...
export default function PlayerDashboard() {
  ...
  useEffect(() => {
    try {
      ...
      if (playerData) {
        ...
        // No player data found, redirect to login
        router.push('/Login');
        return;
      }
    } catch (error) {
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'forms':
        return <Forms player={player} onNavigate={handleTabChange} />;
      case 'hydration-form':
        return <HydrationForm player={player} />;
      case 'monitoring-form':
        return <MonitoringForm player={player} />;
      case 'wellness-form':
        return <WellnessForm player={player} />;
      case 'recovery-form':
        return <RecoveryForm player={player} />;
      case 'history':
